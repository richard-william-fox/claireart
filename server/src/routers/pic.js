...
router.get('/newPics/:skip/:limit/:size', async (req, res) => {
    let where = {'sold': false, 'errored': false, 'newUpload': true}
...
router.get('/soldPics/:skip/:limit/:size', async (req, res) => {
    let where = {'errored': false, 'sold': true}
...
router.get('/countPicsNew/:size', async (req, res) => {
    let where = {'sold': false, 'errored': false, 'newUpload': true}
...
router.get('/countPicsSold/:size', async (req, res) => {
    let where = {'sold': true, 'errored': false}
